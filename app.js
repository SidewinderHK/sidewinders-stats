// Sidewinders Stats Hub - Multi-Season v6.4
    ...
    async loadSeason(seasonId) {
        ...
        try {
            ...
            if (isFullLog) {
                ...
                // IMPORTANT: build the player list BEFORE calculating stats,
                // otherwise playerStats starts empty and every game row is skipped.
